        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
          <Panel className="grid gap-3">
            ...
            <div className="flex flex-wrap gap-2">
              <Link href="/lorecp/actions#create-action" className="rounded-lg bg-emerald-900 px-4 py-2 text-sm font-bold text-emerald-50 hover:bg-emerald-800">Create Action</Link>
              <Link href="/lorecp/actions" className="rounded-lg border border-emerald-300/70 px-4 py-2 text-sm font-bold text-emerald-100 hover:bg-emerald-900/10">Edit Actions</Link>
            </div>
          </Panel>
          <Panel className="grid gap-3">
          ...
          <Panel className="grid gap-3">
            ...
            <Link href="/lorecp/pages/lore" className="rounded-lg border border-emerald-300/70 px-4 py-2 text-sm font-bold text-emerald-100 hover:bg-emerald-900/10">Edit Lore</Link>
          </Panel>
          <Panel className="grid gap-3">
